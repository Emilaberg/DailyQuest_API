...
namespace Backend.Migrations
{
    ...
    [Migration("20240903130045_Added nullable string called Image in the QuestionModel")]
    partial class AddednullablestringcalledImageintheQuestionModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shared.DbModels.EmailModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            EmailId = 1,
                            DateLastSent = new DateTime(2024, 9, 3, 15, 0, 45, 796, DateTimeKind.Local).AddTicks(8422),
                            Email = "Maxtharn@gmail.com"
                        },
                        new
                        {
                            EmailId = 2,
                            DateLastSent = new DateTime(2024, 9, 3, 15, 0, 45, 796, DateTimeKind.Local).AddTicks(8468),
                            Email = "Nckandero@gmail.com"
                        },
                        new
                        {
                            EmailId = 3,
                            DateLastSent = new DateTime(2024, 9, 3, 15, 0, 45, 796, DateTimeKind.Local).AddTicks(8470),
                            Email = "emil.aberg@live.com"
                        },
                        new
                        {
                            EmailId = 4,
                            DateLastSent = new DateTime(2024, 9, 3, 15, 0, 45, 796, DateTimeKind.Local).AddTicks(8471),
                            Email = "e.johannesnilsson@gmail.com"
                        },
                        new
                        {
                            EmailId = 5,
                            DateLastSent = new DateTime(2024, 9, 3, 15, 0, 45, 796, DateTimeKind.Local).AddTicks(8472),
                            Email = "emmzaa1337@gmail.com"
                        },
                        new
                        {
                            EmailId = 6,
                            DateLastSent = new DateTime(2024, 9, 3, 15, 0, 45, 796, DateTimeKind.Local).AddTicks(8473),
                            Email = "Din@Son.lol"
                        },
                        new
                        {
                            EmailId = 7,
                            DateLastSent = new DateTime(2024, 9, 3, 15, 0, 45, 796, DateTimeKind.Local).AddTicks(8475),
                            Email = "Din@Kusin.lol"
                        },
                        new
                        {
                            EmailId = 8,
                            DateLastSent = new DateTime(2024, 9, 3, 15, 0, 45, 796, DateTimeKind.Local).AddTicks(8477),
